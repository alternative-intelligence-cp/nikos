...
define i32 @main() #0 !dbg !8 {
  ...
  call void @llvm.dbg.declare(metadata { double, double }* %1, metadata !12, metadata !DIExpression()), !dbg !14
  %2 = getelementptr inbounds { double, double }, { double, double }* %1, i32 0, i32 0, !dbg !14
  %3 = getelementptr inbounds { double, double }, { double, double }* %1, i32 0, i32 1, !dbg !14
  store double 1.000000e+00, double* %2, align 8, !dbg !14
  store double 2.000000e+00, double* %3, align 8, !dbg !14
  %4 = getelementptr inbounds { double, double }, { double, double }* %1, i32 0, i32 0, !dbg !15
  %5 = load double, double* %4, align 8, !dbg !15
