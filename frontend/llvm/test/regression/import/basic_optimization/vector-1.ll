...
define i32 @main() #0 !dbg !20 {
  ...
  %2 = load <4 x float>, <4 x float>* @b, align 16, !dbg !25
  %3 = fadd <4 x float> %1, %2, !dbg !26
  store <4 x float> %3, <4 x float>* @c, align 16, !dbg !27
  ret i32 0, !dbg !28
}
...
; CHECK: #1 !entry !exit {
; CHECK:   <4 x float> %1 = load @a, align 16
; CHECK:   <4 x float> %2 = load @b, align 16
; CHECK:   <4 x float> %3 = %1 fadd %2
