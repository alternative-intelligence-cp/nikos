...
define i32 @main() #0 !dbg !8 {
  ...
  %5 = call %struct.__sFILE* @"\01_fopen"(i8* %3, i8* %4), !dbg !12
  ...
  %6 = getelementptr inbounds [1025 x i8], [1025 x i8]* %1, i64 0, i64 0, !dbg !85
  %7 = call i8* @fgets(i8* %6, i32 1024, %struct.__sFILE* %5), !dbg !86
  %8 = call i32 @fgetc(%struct.__sFILE* %5), !dbg !87
  %9 = getelementptr inbounds [12 x i8], [12 x i8]* @.str.2, i64 0, i64 0, !dbg !88
  %10 = call i32 @"\01_fputs"(i8* %9, %struct.__sFILE* %5), !dbg !88
  %11 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.3, i64 0, i64 0, !dbg !89
  %12 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %5, i8* %11, i32 1), !dbg !89
  %13 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.3, i64 0, i64 0, !dbg !90
  %14 = call i32 (%struct.__sFILE*, i8*, ...) @fscanf(%struct.__sFILE* %5, i8* %13, i32* %2), !dbg !90
  %15 = call i32 @fflush(%struct.__sFILE* %5), !dbg !91
  %16 = call i32 @fclose(%struct.__sFILE* %5), !dbg !92
  ret i32 0, !dbg !93
}
...
; CHECK:   opaque* %13 = bitcast %9
; CHECK:   opaque* %14 = call %11(%12, 1024, %13)
...
!86 = !DILocation(line: 7, column: 3, scope: !8)
!87 = !DILocation(line: 8, column: 3, scope: !8)
!88 = !DILocation(line: 9, column: 3, scope: !8)
!89 = !DILocation(line: 10, column: 3, scope: !8)
!90 = !DILocation(line: 11, column: 3, scope: !8)
!91 = !DILocation(line: 12, column: 3, scope: !8)
!92 = !DILocation(line: 13, column: 3, scope: !8)
!93 = !DILocation(line: 14, column: 1, scope: !8)
