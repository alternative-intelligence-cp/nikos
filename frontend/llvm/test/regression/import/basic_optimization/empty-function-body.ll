; ModuleID = 'empty-function-body.pp.bc'
source_filename = "empty-function-body.c"
...
define void @GEN2_w_test2_terminate() #0 !dbg !8 {
  ret void, !dbg !11
}
; CHECK: define void @GEN2_w_test2_terminate() {
; CHECK: #1 !entry !exit {
; CHECK:   return
; CHECK: }
