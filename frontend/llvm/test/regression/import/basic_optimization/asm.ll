...
define i32 @main() #0 !dbg !8 {
  ...
  %2 = getelementptr inbounds [4 x i8], [4 x i8]* @.str, i64 0, i64 0, !dbg !17
  %3 = call i32 (i8*, ...) @printf(i8* %2, i32 %1), !dbg !17
  ret i32 %1, !dbg !18
}
...
; CHECK:   si32 (opaque*, ...)* %3 = bitcast @ar.libc.printf
...
!17 = !DILocation(line: 12, column: 3, scope: !8)
