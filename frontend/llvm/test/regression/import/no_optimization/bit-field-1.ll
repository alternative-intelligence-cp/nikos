...
define i32 @main() #0 !dbg !8 {
  ...
  call void @llvm.dbg.declare(metadata %struct.info_t* %2, metadata !12, metadata !DIExpression()), !dbg !20
  %3 = bitcast %struct.info_t* %2 to i8*, !dbg !20
  %4 = getelementptr inbounds { i8, i8, [2 x i8] }, { i8, i8, [2 x i8] }* @__const.main.info, i32 0, i32 0, !dbg !20
...
; CHECK:   {0: si16, 2: [2 x si8]}* $2 = allocate {0: si16, 2: [2 x si8]}, 1, align 4
